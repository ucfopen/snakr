...
function Pantry() {
  ...
  return (
    <div className="pantry">
      <h2 onClick={toggleIS} className={hiddenIS ? "down" : "up"}>
        Current Items in stock{" "}
        <FontAwesomeIcon icon={hiddenIS ? faSortDown : faSortUp} />
      </h2>
      ...
      <h2 onClick={toggleOOS} className={hiddenOOS ? "down" : "up"}>
        Out of stock{" "}
        <FontAwesomeIcon icon={hiddenOOS ? faSortDown : faSortUp} />
      </h2>
